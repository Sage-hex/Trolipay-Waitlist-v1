  ...
  return (
    <div className="min-h-screen bg-app-bg text-text">
      ...
      <Section className="py-6">
        <div className="rounded-xl border border-border bg-card-bg p-6 text-center text-sm text-text-muted shadow-sm">
      ...
      <Section>
        ...
        <div className="mt-6 grid gap-6 md:grid-cols-3">
          {steps.map((step) => {
            ...
            return (
              <article key={step.title} className="rounded-xl border border-border bg-card-bg p-6 shadow-sm">
